...
public class FrmMantClasificacionCuentas extends javax.swing.JInternalFrame {
    ...
    private void JBtnAyudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBtnAyudaActionPerformed
        try {
            if ((new File("rundll32 url.dll,FileProtocolHandler src\\java\\ayuda\\AyudaClasificacion.chm")).exists()) {
                Process p = Runtime
                        .getRuntime()
                        .exec("rundll32 url.dll,FileProtocolHandler src\\java\\ayuda\\AyudaClasificacion.chm");
                p.waitFor();
            } else {
