...
public class PartidaContableDAO extends Conexion1 {
    ...
    public String NroPartida() {
        ...
        try {
            ...
            Connection conexion1 = Conexion1.getConnection();
            PreparedStatement ps = conexion1.prepareStatement(SQL_Maximo);
